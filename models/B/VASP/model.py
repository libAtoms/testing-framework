...
calculator.set_calc_args(Dictionary('vasp=vasp.para INCAR_template="{0}/INCAR.template" kpoints_file=_NONE_ potcar_files={{14 {0}/POTCAR.Si}} persistent=False'.format(mydir)))
