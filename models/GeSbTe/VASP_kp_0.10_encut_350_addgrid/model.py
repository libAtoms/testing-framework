...
VASP.set(vasp=vasp_cmd, incar_template='%s/INCAR.template' % model_dir, kpoints_file='_NONE_', potcar_files='32 %s/pot/Ge/POTCAR 51 %s/pot/Sb/POTCAR 52 %s/pot/Te/POTCAR' % (model_dir, model_dir, model_dir), persistent=False)
