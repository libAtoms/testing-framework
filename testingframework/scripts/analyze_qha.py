...
axs[0].plot(
    qha_data[ref_model_name]["qha_diamond"]["qha_temperature"],
    qha_data[ref_model_name]["qha_diamond"]["qha_heat_capacity"],
...
axs[1].plot(
    qha_data[ref_model_name]["qha_diamond"]["qha_temperature"],
    qha_data[ref_model_name]["qha_diamond"]["qha_gruneisen"],
    label=ref_model_name,
    linestyle=ref_linestyles[0],
    color="black",
)
axs[2].plot(
    qha_data[ref_model_name]["qha_diamond"]["qha_temperature"],
    qha_data[ref_model_name]["qha_diamond"]["qha_thermal_expansion"],
    label=ref_model_name,
    linestyle=ref_linestyles[0],
    color="black",
)
...
for model in sorted(qha_data.keys()):
    if bool(qha_data[model]) is True and model != ref_model_name:
        i += 1
        axs[0].plot(
            qha_data[model]["qha_diamond"]["qha_temperature"],
            qha_data[model]["qha_diamond"]["qha_heat_capacity"],
            label=model,
            color=struct_colors[i],
        )
        axs[1].plot(
            qha_data[model]["qha_diamond"]["qha_temperature"],
            qha_data[model]["qha_diamond"]["qha_gruneisen"],
            label=model,
            color=struct_colors[i],
        )
        axs[2].plot(
            qha_data[model]["qha_diamond"]["qha_temperature"],
            qha_data[model]["qha_diamond"]["qha_thermal_expansion"],
            label=model,
            color=struct_colors[i],
        )
