...
A, B = rss_data[ref_model_name]['gap_6_rss_like_open_ended_minima_rerelax_sd2']["V_unrelaxed"], rss_data[ref_model_name]['gap_6_rss_like_open_ended_minima_rerelax_sd2']["E_unrelaxed"]
C, D = rss_data[ref_model_name]['gap_6_rss_like_open_ended_minima_rerelax_sd2']["V_relaxed"], rss_data[ref_model_name]['gap_6_rss_like_open_ended_minima_rerelax_sd2']["E_relaxed"]
