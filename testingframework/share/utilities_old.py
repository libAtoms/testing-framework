...
def relax_atoms(
    atoms, tol=1e-3, method="lbfgs_precon", max_steps=1000, traj_file=None, **kwargs
):
    import model
...
class SymmetrizedCalculator(Calculator):
    ...
    def __init__(self, calc, atoms, *args, **kwargs):
        ...
        self.calc = calc
        (self.rotations, self.translations, self.symm_map) = symmetrize.prep(
            atoms, symprec=0.01
        )
